...
class TermsServiceTest {
    ...
    void getTerms_success(){
        ...
        Terms terms = Terms.builder()
            ...
            .content("약관 내용")
            .build();
        TermsDto termsDto = TermsDto.fromEntity(terms);
        when(termsReader.findAll()).thenReturn(Collections.singletonList(terms));
        // when
    ...
    void getTerm_success(){
        ...
        Terms terms = Terms.builder()
            ...
            .content("약관 내용")
            .build();
        TermsDto dto = TermsDto.fromEntity(terms);
    ...
    void getTerm_fail_terms_not_found(){
        // given
        when(termsReader.findById(anyLong())).thenReturn(Optional.empty());
        // then
